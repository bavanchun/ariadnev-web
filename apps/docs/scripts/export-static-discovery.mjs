...
export async function runStaticDiscovery({ contentRoot = resolve(appRoot, "content"), outRoot = resolve(appRoot, "out"), catalogPath = resolve(contentRoot, "generated/catalog.json") } = {}) {
