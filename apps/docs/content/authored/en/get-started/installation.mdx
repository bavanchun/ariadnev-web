...
> **Removes a macOS safety check.** The quarantine attribute is how macOS warns about unsigned downloads. Only run this after the installer above has verified the sha256, or after you have downloaded the binary yourself and matched it against `https://ariadnev.com/download/checksums.txt` for the same version.
