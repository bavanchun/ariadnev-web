...
async function writeFixture(root) {
  ...
  const files = new Map([
    ...
    ["llms.txt", "# vcskill docs\n"],
    ["llms-full.txt", "# vcskill docs full\n"],
    ["_next/static/chunk-abc123.js", "globalThis.__vcskillDocsAsset = true;\n"],
...
test("Wrangler applies docs security, cache, and content-type policy to deployed assets", { timeout: 30_000 }, async () => {
  const fixture = await mkdtemp(join(tmpdir(), "vcskill-docs-headers-"));
