...
| 4 | [Authored docs screen experiences](./phase-04-authored-docs-screen-experiences.md) | 1, 2, 3 | Substantially complete (slices 1-12 shipped; every D01-D11 authored screen carries a page-appropriate enrichment sourced from verified content; screen registry with PassThrough renderers ships D02-D11; D00 language-chooser + D18 docs-not-found are app-level. Remaining routed to P7: dedicated React experience components + screen-focused route tests) |
